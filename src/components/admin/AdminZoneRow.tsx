...
export function AdminZoneRow({ zone }: { zone: { id: string; name: string; fee: number; etaLabel: string } }) {
  ...
  return (
    <div className="bg-admin-surface border border-admin-text/9 rounded-2xl p-3.75 flex flex-wrap gap-2.5 gap-x-3.5 items-center">
      <div className="text-[15px] font-extrabold text-admin-text flex-1 min-w-37.5">{zone.name}</div>
